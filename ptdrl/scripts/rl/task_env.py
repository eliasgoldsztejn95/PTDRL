...
class PtdrlTaskEnv(robot_env.PtdrlRobEnv):
    ...
    def proccess_is_dones(self, is_dones):
        is_dones = is_dones.sort()
        if is_dones[-1] == 1:
            return 1
        return 0
    
    def process_obs(self, obs):
        np_obs = np.zeros([1,self.self.num_obs_for_prediction,(self.num_tracks)*2])
    ...
    def goal_reached(self):
        ...
        return self.status_move_base == 3
